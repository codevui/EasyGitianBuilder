...
sudo tar -C /home/vagrant --one-file-system --exclude gitian-builder/base-bionic-amd64 --exclude gitian-builder/target-bionic-amd64  -cpv .  | sudo tar -C /mnt -xpf -
sudo cp -a --sparse=always /home/vagrant/gitian-builder/base-bionic-amd64 /mnt/gitian-builder/
sudo cp -a --sparse=always /home/vagrant/gitian-builder/target-bionic-amd64 /mnt/gitian-builder/
