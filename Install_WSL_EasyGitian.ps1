...
Begin {
    ...
    if (Test-Path $MyExe) {
       Start-Process $MyExe -ArgumentList 'run wget -N -O $HOME/Install_EasyGitian.sh https://raw.githubusercontent.com/codevui/easygitianbuilder/v0.1.0/Install_EasyGitian.sh'
       Start-Process $MyExe 
       #Exit
       }
    else {
